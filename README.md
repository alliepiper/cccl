...
In the spirit of "You only support what you test", see the [CI section of CONTRIBUTING.md](CONTRIBUTING.md#continuous-integration-ci) for more information on exactly what we test.
...
For more information about our CI pipeline, see [CONTRIBUTING.md](CONTRIBUTING.md#continuous-integration-ci).
...
For a detailed overview of the CI pipeline, see [CONTRIBUTING.md](CONTRIBUTING.md#continuous-integration-ci).
